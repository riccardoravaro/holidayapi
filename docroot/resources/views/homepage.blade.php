    ...
    <body>
        <div class="container">
            <div class="col-xs-12 col-sm-6 col-sm-offset-3">
                ...
                <div class="well">
                    <h2>Usage example</h2>
                    <p>To retrieve a list of holidays, simply make a GET request to <a href="/api/v1/holidays?country=US&year=<?= date('Y'); ?>&month=<?= date('m'); ?>" target="_blank">/v1/holidays</a></p>
                </div>
                ...
                <div class="well">
                    ...
                    <div class="row">
                        <div class="col-xs-3"><code>bank_holiday</code></div>
                        <div class="col-xs-9">show only official bank holidays</div>
                    </div>
                </div>
